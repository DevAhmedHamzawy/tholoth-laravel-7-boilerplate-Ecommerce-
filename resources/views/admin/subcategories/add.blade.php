...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <h2 class="card-header text-center">إضافة تصنيف فرعى جديد</h2>

                <div class="card-body">
                    <form method="POST" action="{{ route('subcategories.store' , $category->slug) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            @foreach ($options as $option)
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="options[]" id="inlineRadio1" value="{{ $option->id }}">
