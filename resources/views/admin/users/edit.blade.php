...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h4 class="text-center">تعديل بيانات العميل</h4></div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('users.update', $user->name) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="credits" type="number" class="form-control @error('credits') is-invalid @enderror" name="credits" value="{{ $user->credits }}" required autocomplete="new-password">
