...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h4 class="text-center">إضافة  عميل جديد</h4></div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="credits" class="col-md-2 col-form-label text-md-right">الرصيد</label>

                            <div class="col-md-10">
                                <input id="credits" type="number" class="form-control @error('credits') is-invalid @enderror" name="credits" required autocomplete="new-password">
