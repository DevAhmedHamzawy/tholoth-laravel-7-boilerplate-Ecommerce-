                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item"> 
                    ...
                    <ul class="sub-menu collapse" id="d_one"  >
                      <li class="nav-item"><a href="{{ url('admin/orders') }}" class="nav-link px-2"><span class="text text-white"> >> الطلبات </span></a></li>
                      <li class="nav-item"><a href="{{ url('admin/returnings') }}" class="nav-link px-2"><span class="text text-white"> >> الإرجاع </span></a></li>
                  ...
                  <li class="nav-item"><a href="{{ url('vendor/v_orders') }}" class="nav-link px-2"><i class="material-icons icon">collections</i><span class="text">الطلبات</span></a></li>
                  <li class="nav-item"><a href="{{ url('vendor/v_returnings') }}" class="nav-link px-2"><i class="material-icons icon">collections</i><span class="text">الإرتجاعات</span></a></li>
