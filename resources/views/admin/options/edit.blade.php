                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('options.update' , $option->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $option->name }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            @foreach ($option->options as $theSpecificOption)

                                <label for="options" class="col-md-2 col-form-label text-md-right">الإختيارات</label>
                                <div class="col-md-10">

                                <input id="options" type="text" class="form-control @error('options') is-invalid @enderror" name="options[]" value="{{ $theSpecificOption }}" required autocomplete="options" autofocus>
