                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('the_vendor_products.store', $vendor->user_name) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12" id="the_icon">
                            <img src="{{ asset('admin/panel/img/upload.png') }}" style="width:120px;height:120px;margin: 16px 44.5%;background-color: black;" class="the_image_changing"  onclick="document.getElementById('image').click()" alt="Cinque Terre">
