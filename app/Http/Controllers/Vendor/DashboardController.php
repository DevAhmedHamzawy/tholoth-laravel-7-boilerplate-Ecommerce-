...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $productCount = Product::whereUserId(auth()->user()->id)->count();
        $orderCount = rand(0, 5);
       ...
       $ProductsInYearChart->height(200);
        ...
        return view('vendor.dashboard', compact('productCount', 'orderCount', 'clientsCount', 'vendorsCount',  'OrdersInYearChart', 'countCategoryChart' ,'ProductsInYearChart' , 'postsByMonthChartTwo', 'users', 'admins'));
